...
namespace :install do
  ...
  task :brew_cask do
    ...
    unless system('brew tap | grep homebrew/homebrew-cask > /dev/null') || system('brew tap homebrew/homebrew-cask')
      abort "Failed to tap homebrew/homebrew-cask in Homebrew."
    end
  end
